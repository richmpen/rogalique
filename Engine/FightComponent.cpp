...
{
    FightComponent::FightComponent(GameObject* gameObject)
        : Component(gameObject)
    {
        ...
        collider->SubscribeCollision([this](Collision collision) {
            ...
            FightComponent* otherFight = otherObject->GetComponent<FightComponent>();
    ...
    void FightComponent::TakeDamage(int damageValue)
    {
        ...
        LOG_INFO(gameObject->GetName() << ": Get damage " << damageValue << ", Current health " << std::to_string(GetHealth()));
    ...
    void FightComponent::SetDamage(int damage)
    {
        this->damage = damage;
    }

    int FightComponent::GetDamage()
    {
        return this->damage;
    }

    void FightComponent::SetHealth(int health)
    {
        this->health = health;
    }

    int FightComponent::GetHealth()
    {
        return this->health;
    }

    void FightComponent::SetTargetType(EnemyType type)
    {
        this->targetType = type;
    }

    EnemyType FightComponent::GetTargetType() const
    {
        return targetType;
    }
