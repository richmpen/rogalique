...
void GameStateRecords::Control(const sf::Event& event) {
...
void GameStateRecords::Shutdown() {};
...
void GameStateRecords::Draw(sf::RenderWindow& window) {
    ...
    sf::Vector2f tablePosition = {titleText.getGlobalBounds().left,
                                  viewSize.y / 2.f};
    DrawTextList(window, textsList, 10.f, Orientation::Vertical, Alignment::Min,
                 tablePosition, {0.f, 0.f});
