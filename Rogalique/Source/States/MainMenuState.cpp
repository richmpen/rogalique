...
MainMenuState::MainMenuState() {
    auto uiGameObject =
        EngineCore::GameWorld::Instance()->CreateGameObject("MainMenuUI");
...
void MainMenuState::CreateUI() {
    ...
    logo = std::make_shared<ImageUI>("logo", sf::Vector2f(0.4f, 0.4f),
                                     sf::Vector2f(300, 150));
    logo->SetCenterOrigin();
    uiManager->AddElement(logo);

    playButton = std::make_shared<ButtonUI>(
        "Play", "UiMap2", sf::IntRect(1649, 1524, 1216, 182),
        sf::Vector2f(300.f, 400.f), sf::Vector2f(400.f, 50.f),
        sf::Color::Green);
    ...
    settingsButton = std::make_shared<ButtonUI>(
        "Settings", "UiMap2", sf::IntRect(1649, 1524, 1216, 182),
        sf::Vector2f(320.f, 400.f + 80.f), sf::Vector2f(400.f, 50.f),
        sf::Color::Green);
    ...
    exitButton = std::make_shared<ButtonUI>(
        "Exit", "UiMap2", sf::IntRect(1649, 1524, 1216, 182),
        sf::Vector2f(340.f, 400.f + 160.f), sf::Vector2f(400.f, 50.f),
        sf::Color::Red);
...
void MainMenuState::Render() { uiManager->Render(); }
