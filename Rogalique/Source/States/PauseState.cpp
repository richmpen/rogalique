...
PauseState::PauseState() {
    ...
    auto uiGameObject =
        EngineCore::GameWorld::Instance()->CreateGameObject("PauseUI");
...
void PauseState::Render() { uiManager->Render(); }
...
void PauseState::CreateUI() {
    ...
    continueButton = std::make_shared<ButtonUI>(
        "Continue", "UiMap2", sf::IntRect(1649, 1524, 1216, 182),
