...
namespace Rogalique {
    PlayState::PlayState() {
        ...
        auto uiGameObject = EngineCore::GameWorld::Instance()->CreateGameObject("PlayStateUI");
    ...
    void PlayState::CheckGameStates() {
        ...
        if (!player) {
            EngineCore::GameStateManager::Instance()->ChangeState(std::make_shared<GameOverState>());
            return;
        }
        ...
        if (SettingsState::enemiesEnabled) {
            ...
            if (!hasEnemies) {
                ...
                EngineCore::GameStateManager::Instance()->ChangeState(std::make_shared<VictoryState>());
            }
        }
